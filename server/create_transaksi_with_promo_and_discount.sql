...
CREATE OR REPLACE FUNCTION public.create_transaksi_with_promo_and_discount(
    ...
    p_loyalty_reward_id VARCHAR DEFAULT NULL,
...
BEGIN
    ...
    INSERT INTO transaksi (
        ...
        total_diskon_final,
        loyalty_reward_id, loyalty_discount, points_redeemed,
        ...
        p_loyalty_reward_id, v_total_diskon_loyalty, COALESCE(p_points_redeemed, 0),
