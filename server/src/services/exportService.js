...
class ExportService {
  ...
  static getColumnsForReportType(reportType) {
    const columnDefinitions = {
      ...
      shift: [
        { header: "No", key: "no", width: 5, align: "center" },
        { header: "Kasir", key: "kas ir", width: 20 },
        { header: "Cabang", key: "cabang", width: 18 },
        { header: "Waktu Mulai", key: "waktuMulai", width: 18 },
        { header: "Waktu Selesai", key: "waktuSelesai", width: 18 },
        { header: "Status", key: "status", width: 12 },
        { header: "Kas Awal", key: "kasAwal", width: 15, format: "currency", align: "right" },
        { header: "Kas Akhir", key: "kasAkhir", width: 15, format: "currency", align: "right" },
        { header: "Total Transaksi", key: "totalTransaksi", width: 12, align: "right" },
        { header: "Total Pendapatan", key: "totalPendapatan", width: 18, format: "currency", align: "right" },
        { header: "Selisih Kas", key: "selisihKas", width: 15, format: "currency", align: "right" },
      ],
      transaction_detail: [
        { header: "No", key: "no", width: 5, align: "center" },
      ...
      customer: [
        ...
        { header: "Segmen", key: "segmen", width: 12 },
        { header: "Total Transaksi", key: "totalTransaksi", width: 12, align: "right" },
        { header: "Total Belanja", key: "totalBelanja", width: 18, format: "currency", align: "right" },
        { header: "Rata-rata Transaksi", key: "avgTransaksi", width: 18, format: "currency", align: "right" },
        { header: "Poin", key: "poin", width: 10, align: "right" },
        { header: "Terakhir Belanja", key: "terakhirBelanja", width: 15 },
      ],
      promo: [
        { header: "No", key: "no", width: 5, align: "center" },
        { header: "Nama Promo", key: "namaPromo", width: 25 },
        { header: "Kode Promo", key: "kodePromo", width: 15 },
        { header: "Tipe Diskon", key: "tipeDiskon", width: 12 },
        { header: "Total Penggunaan", key: "totalPenggunaan", width: 12, align: "right" },
        { header: "Total Diskon", key: "totalDiskon", width: 18, format: "currency", align: "right" },
        { header: "Avg Diskon", key: "avgDiskon", width: 15, format: "currency", align: "right" },
        { header: "Total Transaksi", key: "totalTransaksi", width: 15, format: "currency", align: "right" },
        { header: "ROI", key: "roi", width: 12, format: "percentage", align: "right" },
        { header: "Status", key: "status", width: 12 },
      ],
    };
