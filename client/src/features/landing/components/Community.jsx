...
const Community = () => {
  return (
    <div className="relative py-24 bg-gradient-to-b from-gray-50/50 via-blue-50/30 to-white overflow-hidden" id="community">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white border border-gray-100 p-8 rounded-3xl shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
            ...
            <a href="https://github.com/ABSUKANGHUROYKI/Casir-Online" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 rounded-lg text-sm font-semibold transition-all w-full md:w-auto">Beri Dukungan</a>
          </div>
          ...
          <div className="bg-white border border-indigo-100 p-8 rounded-3xl shadow-md hover:shadow-xl hover:border-indigo-200 transition-all duration-300 group hover:-translate-y-1">
            ...
            <a href="https://github.com/ABSUKANGHUROYKI/Casir-Online/pulls" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-semibold transition-all shadow-sm w-full md:w-auto">Upload Kode Anda</a>
          </div>
          ...
          <div className="bg-white border border-gray-100 p-8 rounded-3xl shadow-sm hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
            ...
            <a href="https://github.com/ABSUKANGHUROYKI/Casir-Online/issues" target="_blank" rel="noopener noreferrer" className="inline-block px-6 py-2.5 bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 rounded-lg text-sm font-semibold transition-all w-full md:w-auto">Laporkan Isu</a>
          </div>
        </div>
      </div>
    </div>
