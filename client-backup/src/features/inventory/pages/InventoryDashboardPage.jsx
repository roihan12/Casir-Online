  ...
  return (
    <div className="pb-6">
      ...
      <div className="flex flex-col items-center justify-center bg-indigo-600 text-white py-8 mb-6">
        <h1 className="text-2xl font-bold mb-2">Dashboard Inventori {USE_MOCK_DATA ? '(Mock Data)' : ''}</h1>
        <div className="flex items-center">
          <BarChart3 size={24} className="mr-2" />
          <span>Pantau metrik dan statistik inventori</span>
        </div>
      </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-green-50 p-4 rounded-lg text-center mb-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm text-gray-500 mb-1">Total Nilai Inventori (Beli)</p>
                          <p className="text-xl font-bold text-green-600">
                            {formatCurrency(categoryValueData.reduce((sum, category) => sum + (parseFloat(category.nilai_inventori_beli) || 0), 0) || 0)}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500 mb-1">Total Nilai Inventori (Jual)</p>
                      ...
                      <div className="mt-3 pt-3 border-t border-green-100">
                        <p className="text-sm text-gray-500 mb-1">Potensi Keuntungan</p>
                            ...
                            <div key={index} className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <div className="grid grid-cols-2 gap-4 mb-2">
                                <div>
                                  ...
                                  <p className="text-sm font-medium text-green-600">{formatCurrency(parseFloat(category.nilai_inventori_beli) || 0)}</p>
                                </div>
                                <div>
                                  <p className="text-xs text-gray-500">Nilai Jual</p>
                                  <p className="text-sm font-medium text-indigo-600">{formatCurrency(parseFloat(category.nilai_inventori_jual) || 0)}</p>
                                </div>
                              </div>
