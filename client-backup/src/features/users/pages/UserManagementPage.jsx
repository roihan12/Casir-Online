      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-2">
          <Can anyPermissions={["role:read", "permission:read"]}>
            <button onClick={() => navigate("/users/roles")} className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg flex items-center hover:bg-gray-200">
              <Users className="h-5 w-5 mr-2" /> Roles & Perizinan
            </button>
          </Can>
          <Can permission="user:create">
            <button onClick={handleAddUser} className="bg-indigo-600 text-white px-4 py-2 rounded-lg flex items-center hover:bg-indigo-700">
